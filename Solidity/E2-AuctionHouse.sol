...
//The following function computes the bytecode of a contract at creation time
        ...
        returns (bytes memory)
    {
        ...
        bytes memory bytecode = type(EnglishAuction).creationCode;
	...
	returns (address) {
			...
			require(!liveAuctionsByContract[checkAddress], "this NFT by Seller is currently on sale!");
			...
			EnglishAuction newAuction = new EnglishAuction{salt: salt}(_nft, _nftId, _sellerAddress);
